/*
  ...
  SPDX-FileCopyrightText: 2025 Will Reed (modifications for God language)
  
  This file is based on Highlight.js 10.1.1 (93fd0d73)
  Original: https://github.com/highlightjs/highlight.js
  
  Modified to add God language syntax highlighting by removing
  unused language definitions and adding custom God language grammar.
  Added also a copy of https://github.com/highlightjs/cdn-release
  `build/languages/lisp.min.js` for usage in some examples; license identifier
  and copyright text is identical to that of highlight.js
